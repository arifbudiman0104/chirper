    ...
    <div class="max-w-2xl p-4 mx-auto sm:p-6 lg:p-8">
        ...
        <form method="POST" action="{{ route('chirps.store') }}">
            ...
            <textarea name="message" placeholder="{{ __('What\'s on your mind?') }}"
                class="block w-full border-gray-100 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('message') }}</textarea>
